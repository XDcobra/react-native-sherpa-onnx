...
object PipelineAudioErrorCodes {
  ...
  const val TRANSFER_INVALID_STATE = "TRANSFER_INVALID_STATE"
  const val TRANSFER_SPOOL_UNAVAILABLE = "TRANSFER_SPOOL_UNAVAILABLE"
  const val TRANSFER_CURSORS_ACTIVE = "TRANSFER_CURSORS_ACTIVE"
  const val BUFFER_INVALIDATED = "BUFFER_INVALIDATED"
