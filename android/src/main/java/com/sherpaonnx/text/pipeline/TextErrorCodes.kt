...
object TextErrorCodes {
  ...
  const val SPOOL_UNAVAILABLE = "TEXT_SPOOL_UNAVAILABLE"
  const val SPOOL_WRITE_FAILED = "TEXT_SPOOL_WRITE_FAILED"
  const val SPOOL_READ_FAILED = "TEXT_SPOOL_READ_FAILED"
  const val SPOOL_CORRUPTED = "TEXT_SPOOL_CORRUPTED"
