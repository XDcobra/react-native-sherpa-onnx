...
> [!NOTE]
> `setPartial()` und `appendPartial()` sind **neue public JSI APIs** für LiveTextBuffer. `getSegmentBuffer()` ist die **neue einheitliche Zugriffs-API** für Segmente beider Domains.
