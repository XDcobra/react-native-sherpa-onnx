...
const char* AudioTaggingModelKindToString(AudioTaggingModelKind k) {
    switch (k) {
        case AudioTaggingModelKind::kCed: return "ced";
        case AudioTaggingModelKind::kZipformer: return "zipformer";
        default: return "unknown";
    }
}
