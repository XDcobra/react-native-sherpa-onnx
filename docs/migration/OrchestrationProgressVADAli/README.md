...
- **Separation** — shipped (`createSeparation`, offline batch + live overload with orchestration progress). See [separation-offline.md](../../separation-offline.md) and [separation-live.md](../../separation-live.md).
