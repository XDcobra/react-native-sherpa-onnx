...
export default function AudioVisualizationScreen() {
  ...
  const onSwitchMode = useCallback(
    (mode: ViewMode) => {
      if ((mode === 'animated' || mode === 'heatmap') && !timelineAvailable) {
        return;
      }
      setViewMode(mode);
    },
        ...
        {!loading && !profile && !error ? (
          <View style={styles.placeholderSection}>
            <Text style={styles.placeholderText}>
              One compute run fills Static, Animated, and Heatmap views.
            </Text>
          </View>
        ) : null}
            ...
            <View style={styles.section}>
              ...
              {!timelineAvailable ? (
                <Text style={styles.disabledNote}>
                  Timeline not available. Animated and Heatmap need timeline
                  frames.
                </Text>
              ) : null}
            </View>
